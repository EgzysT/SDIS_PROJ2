...
//
//    private javax.net.ssl.SSLServerSocket s;
...
//
//        try {
//            s = (javax.net.ssl.SSLServerSocket) ssf.createServerSocket(port);
//
//        }
//        catch(IOException e) {
...
//
//        while (true) {
//            try (javax.net.ssl.SSLSocket sslSocket = (javax.net.ssl.SSLSocket) s.accept()) {
//
...
//
////        System.setProperty("javax.net.ssl.keyStore", System.getProperty("user.dir") + File.separator + "src" + File.separator + "ssl" + File.separator + "server.keys");
////        System.setProperty("javax.net.ssl.keyStorePassword", "123456");
//
